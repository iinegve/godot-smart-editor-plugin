...
const SETTING_REFERENCE_COUNT_PREFIX := SETTINGS_PREFIX + &"reference_counts/"
const SETTING_REFERENCE_COUNT_ENABLED := SETTING_REFERENCE_COUNT_PREFIX + &"enabled"
const SETTING_REFERENCE_COUNT_COLOR := SETTING_REFERENCE_COUNT_PREFIX + &"label_color"
...
const REMOVED_SETTING_DIALOG_WIDTH := SETTING_EDITOR_PREFIX + &"dialog_width"
const REMOVED_SETTING_LEGACY_DIALOG_WIDTH := SETTINGS_PREFIX + &"dialog_width"
...
static func init_editor_settings() -> void:
	...
	_erase_removed_settings([
		...
		REMOVED_SETTING_DIALOG_WIDTH,
		REMOVED_SETTING_LEGACY_DIALOG_WIDTH,
...
static func init_reference_count_settings() -> void:
	_init_setting(SETTING_REFERENCE_COUNT_ENABLED, true, TYPE_BOOL, PROPERTY_HINT_NONE, "")
	_init_setting(SETTING_REFERENCE_COUNT_COLOR, Color(0.55, 0.55, 0.55, 0.85), TYPE_COLOR, PROPERTY_HINT_NONE, "")
